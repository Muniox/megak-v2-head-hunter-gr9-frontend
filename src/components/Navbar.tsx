            ...
            <div className="relative inline-block text-left">
              <button type="button"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                     stroke="currentColor" className="w-14 h-14 text-dropdown-svg-and-search-placeholder-color">
              ...
              {toggle && (
                <div className="absolute right-0 z-10 md:mt-3 w-64 origin-top-right bg-primary-border-color py-2">
                  <ul>
                    <li
                      className="block px-6 py-2 text-primary-font-color hover:bg-primary-color hover:text-primary-placeholder-font-color border-b-2 border-divider-line-color">
                      <Link to='/account'>Konto</Link>
                    </li>
                    <li
                      className="block px-6 py-2 text-primary-font-color hover:bg-primary-color hover:text-primary-placeholder-font-color">
