...
//TODO - refactor kodu + dodanie funkcjonalności: wylogowanie, przejście do profilu, wyświetlenie avatara i nazwy użytkownika
//TODO stworzyć osobny komponent dla avatara + jego obsługa w zależności kto jest zalogowany
