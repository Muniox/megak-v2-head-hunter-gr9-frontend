...
export const StudentDetails: React.FC = () => {
  ...
  return (
    <div className="flexw-4/5 bg-secondary-color">
        ...
        <div className="pt-2 inline-block w-full ">
          <div className="shadow">
            ...
            <table {...getTableProps()} className="min-w-full">
              ...
              {/* eslint-disable-next-line react/jsx-props-no-spreading */}
              <tbody {...getTableBodyProps()} className="bg-student-information-field-color ">
                {rows.map((row) => {
                  prepareRow(row);
                  return (
                    // eslint-disable-next-line react/jsx-props-no-spreading
                    <tr {...row.getRowProps()}>
                      ...
                      {row.cells.map((cell) => (
                        <td
                          {...cell.getCellProps()}
                          className="px-2 py-1 text-2xs text-available-students-details-font-color font-sans font-black border-r-2 border-secondary-color "
                        >
                          {cell.render('Cell')}
                        </td>
                      ))}
